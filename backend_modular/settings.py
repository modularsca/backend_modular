"""
Django settings for backend_modular project.
...
SECRET_KEY = 'django-insecure-5nn9umaz^24-s#k33rlw+*r74n5o9!9l9!euhp_h!b@)!t71%i'
...
ROOT_URLCONF = 'backend_modular.urls'
...
WSGI_APPLICATION = 'backend_modular.wsgi.application'
